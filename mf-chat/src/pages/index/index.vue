...
export default {
  data() {
    return {
      users: [
        ...
        { avatar: 'https://up.enterdesk.com/edpic_source/30/90/40/309040a0602c672cebc6ab3a1bbbc8cd.jpg', name: '月野氿桃', read: 1 },
  ...
  methods: {
    connect(item) {
      uni.navigateTo({
        url: `/pages/index/message?name=${item.name}&avatar=${item.avatar}`
      })
    }
  }
}
